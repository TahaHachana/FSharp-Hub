(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,WebSharper,Formlet,Controls,Enhance,Data,Formlet1,Remoting,alert,Concurrency,Html,Operators,Default,List,Website,BooksAdmin,Client,HTML5,Login,Client1,window,EventsPervasives,jQuery,Arrays,Questions,Client2,T,Snippets,Client3,Tweets,Client4,Seq,VideosAdmin,Client5;
  ...
  Website:{
    ...
    Client:{
     addFormlet:Runtime.Field(function()
     {
      ...
      return Formlet1.Run(Runtime.Tupled(function(tupledArg)
      {
       ...
       {
        var xe,fd;
        xe=Remoting.Async("Website:2",[url,title,authors,publisher,isbn,pages,date,cover]);
        fd=function(_arg1)
        {
         if(_arg1)
          {
      ...
      submitBtn=(x=(el=Default.Button(List.ofArray([Default.Attr().Class("btn btn-primary btn-block"),(_this3=Default.Attr(),_this3.NewAttr("id","login-btn")),(_this4=Default.Attr(),_this4.NewAttr("type","button"))])),(inner=Default.Text("Submit"),Operators.add(el,List.ofArray([inner])))),(f=(x1=function()
      {
       return function()
       {
        ...
        x2=(f1=function()
        {
         ...
         x3=Remoting.Async("Website:6",[info]);
         f2=function(_arg11)
         {
          if(_arg11.$==1)
           {
   ...
   Questions:{
    Client:{
     ...
     li:function(link,title,date,website,summary)
     {
      ...
      return Operators.add(Default.LI(List.ofArray([Default.Attr().Class("list-group-item")])),List.ofArray([Operators.add(Default.A(List.ofArray([Default.HRef(link)])),List.ofArray([(x=List.ofArray([Default.Text(title)]),(_this=Default.Tags(),_this.NewTag("strong",x)))])),Default.Br(Runtime.New(T,{
       $:0
   ...
   Snippets:{
    Client:{
     ...
     {
      var x,_this;
      return Operators.add(Default.LI(List.ofArray([Default.Attr().Class("list-group-item")])),List.ofArray([Operators.add(Default.A(List.ofArray([Default.HRef(link)])),List.ofArray([(x=List.ofArray([Default.Text(title)]),(_this=Default.Tags(),_this.NewTag("strong",x)))])),Default.P(List.ofArray([Default.Text(description)]))]));
     },
     main:function()
     {
      var x,f,f1;
    ...
    Client:{
     main:function()
     {
      ...
      return Formlet1.Run(Runtime.Tupled(function(tupledArg)
      {
       ...
       {
        var x9,f8;
        x9=Remoting.Async("Website:0",[title,url,thumb,website,date]);
        f8=function(_arg1)
        {
         if(_arg1)
          {
